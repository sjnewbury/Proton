...
OPTIMIZE_FLAGS := -Ofast -march=native -mtune=native -pipe -fvect-cost-model=dynamic -malign-data=cacheline -falign-functions=64 -flimit-function-alignment -DNDEBUG
